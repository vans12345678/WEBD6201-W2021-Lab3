...
((core) =>
{
  ...
  /**
   * Adds link events to nav bar items
   */
   ...
   */
    ...
    /**
     * Function to add must be logged in permissions
     */
    function authGuard()
    {
      if(!sessionStorage.getItem("user"))
    ...
    /**
     * Switches active link depending on which page the user is on
     * @param {*} activeLink 
     * @returns 
     */
